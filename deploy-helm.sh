...
# helm init --service-account tiller --upgrade -i registry.cn-hangzhou.aliyuncs.com/google_containers/tiller:v2.14.0 --stable-repo-url http://mirror.azure.cn/kubernetes/charts/
...
# curl -L -o /usr/bin https://github.com/roboll/helmfile/releases/download/v0.82.0/helmfile_linux_amd64 && chmod +x /usr/bin/helmfile
